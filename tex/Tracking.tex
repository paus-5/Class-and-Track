...
The model here presented serves to illustrate that by considering a more complex growth rate that accounts for ecological interactions one might explain differences in reactors operating similarly. It also shows a new mechanism by which the CEP no longer holds. However the quadratic increase of parameters with the number of OTU considered makes it difficult to accurately calibrate the model. The operating diagrams always show a single stable equilibrium point for each pair $(s_in,D)$, however no proof is offered to such conjecture. In the next section, a generalization of the former model, and a schema for calibrating a class of models is presented as well.
...
\begin{figure}[ht]
	...
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{OTU_no_control}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{metabolites_no_control}
	\end{subfigure}
...
\begin{figure}
	\centering
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_1//Prediction_Constrained_Control_2_OTU_Iter_1}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_1//Prediction_Constrained_Control_2_metabolites_Iter_1}
	\end{subfigure}
	~	
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_1//Prediction_Constrained_Control_2_OTU_Iter_5}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_1//Prediction_Constrained_Control_2_metabolites_Iter_5}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_1//Prediction_Constrained_Control_2_OTU_Iter_25}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_1//Prediction_Constrained_Control_2_metabolites_Iter_25}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_1//Prediction_Constrained_Control_2_OTU_Iter_45}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_1//Prediction_Constrained_Control_2_metabolites_Iter_45}
	\end{subfigure}
...
\begin{figure}
	\centering
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_1//Prediction_Constrained_Control_2_Control_Iter_1}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_1//Prediction_Constrained_Control_2_Control_Iter_5}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_1//Prediction_Constrained_Control_2_Control_Iter_25}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
	\includegraphics[width=\textwidth]{Case_1//Prediction_Constrained_Control_2_Control_Iter_45}
	\end{subfigure}
...
\begin{figure}
	\centering
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_2//Prediction_Constrained_Control_6_OTU_Iter_1}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_2//Prediction_Constrained_Control_6_metabolites_Iter_1}
	\end{subfigure}
	~	
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_2//Prediction_Constrained_Control_6_OTU_Iter_5}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_2//Prediction_Constrained_Control_6_metabolites_Iter_5}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_2//Prediction_Constrained_Control_6_OTU_Iter_15}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_2//Prediction_Constrained_Control_6_metabolites_Iter_15}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_2//Prediction_Constrained_Control_6_OTU_Iter_25}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_2//Prediction_Constrained_Control_6_metabolites_Iter_25}
	\end{subfigure}
...
\begin{figure}
	\centering
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_2//Prediction_Constrained_Control_6_Control_Iter_1}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_2//Prediction_Constrained_Control_6_Control_Iter_5}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_2//Prediction_Constrained_Control_6_Control_Iter_15}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_2//Prediction_Constrained_Control_6_Control_Iter_25}
	\end{subfigure}
...
\begin{figure}
	\centering
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_3//Prediction_Constrained_Control_7_OTU_Iter_1}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_3//Prediction_Constrained_Control_7_metabolites_Iter_1}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_3//Prediction_Constrained_Control_7_OTU_Iter_5}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_3//Prediction_Constrained_Control_7_metabolites_Iter_5}
	\end{subfigure}
	~
		\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_3//Prediction_Constrained_Control_7_OTU_Iter_15}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_3//Prediction_Constrained_Control_7_metabolites_Iter_15}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_3//Prediction_Constrained_Control_7_OTU_Iter_25}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_3//Prediction_Constrained_Control_7_metabolites_Iter_25}
	\end{subfigure}
...
\begin{figure}
	\centering
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_3//Prediction_Constrained_Control_7_Control_Iter_1}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_3//Prediction_Constrained_Control_7_Control_Iter_5}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
		\includegraphics[width=\textwidth]{Case_3//Prediction_Constrained_Control_7_Control_Iter_15}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.32\textheight}
	\includegraphics[width=\textwidth]{Case_3//Prediction_Constrained_Control_7_Control_Iter_25}
	\end{subfigure}
