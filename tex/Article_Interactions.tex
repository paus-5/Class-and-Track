...
For checking local asymptotic stability of the equilibria points, the Jacobian of the system is provided and evaluated at each of these points. The resulting matrix's eigenvalues must have negative real part. A general formula for this Jacobian is presented in the supplementary material.
...
As shown in operating diagram \ref{Parameters Modified}, there exists a bi stability zone, which is corroborated from a simulation: depending on the initial conditions of the system the predicted outcome might vary. The therefores
