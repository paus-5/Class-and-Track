...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\linewidth]{proof_of_concept/250309_POC_metabolites}
	\caption{}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\textwidth]{proof_of_concept/250309_POC_try3_Biomass_iter_2}
	\caption{Dotted line: simulated total biomass for model \eqref{system} \iffalse quels paramètres ?\fi. Continuous line: total biomass as predicted  by the tracking procedure.}
	\label{Total Biomass no noise}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\textwidth]{proof_of_concept/250309_POC_try3_AOB_iter_2_plot_1}
	\caption{Dotted line: simulated AOB biomass. Continuous line: the tracking procedure results.}
	\label{AOB no noise}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\textwidth]{proof_of_concept/250309_POC_try3_NOB_iter_2_plot_1}
	\caption{NOB biomass. Dotted line: simulated data. Continuous line: the tracking procedure results.}
	\label{NOB no noise}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\textwidth]{proof_of_concept/250309_POC_try3_metabolites_iter_2}
...
\begin{figure}[h]
	\centering
	\begin{subfigure}{0.45 \linewidth}
		\includegraphics[width=\linewidth]{proof_of_concept/250309_POC_try3_Control_AOB_iter_2_plot_1}
	\caption{Control for the AOB population.}
	\label{Control AOB no noise}
	\end{subfigure}
	\begin{subfigure}{0.45 \linewidth}
		\centering
		\includegraphics[width=\linewidth]{proof_of_concept/250309_POC_try3_Control_NOB_iter_2_plot_1}
...
\begin{figure}[h]
	\centering
	\begin{subfigure}{0.45 \linewidth}
		\includegraphics[width=\linewidth]{proof_of_concept/250309_POC_try3_growth_AOB_iter_2_plot_1}
		\caption{Growth rate of the model for AOB community.}
		\label{AOB_growth_POC}
	\end{subfigure}
	\begin{subfigure}{0.45 \linewidth}
		\centering
		\includegraphics[width=\linewidth]{proof_of_concept/250309_POC_try3_growth_NOB_iter_2_plot_1}
	\caption{Growth rate of the model for the NOV community.}
