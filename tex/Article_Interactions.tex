...
\begin{figure}[ht]
	...
	\end{subfigure}
	\caption{Left: interactions of the system. Right: operating diagram of Model \eqref{system}, with parameters in Table \ref{Parameters Modified}. The 8 different zones represent the surviving species in the steady state. PN takes place when neither $x_3$ nor $x_4$ are present. CN takes place if $x_3$ or $x_4$ are present.}
	\label{OD modified}
\end{figure}
\clearpage
