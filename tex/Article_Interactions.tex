...
Two examples are used for illustrating the diversity of situations that may arise from this type of system. Kinetic parameters of cases 1 and 2 can be seen in table \ref{kinetic_parameters}. Interaction matrices of each case are shown in figure \ref{Interactions}. Case 1 was taken from Dumont \textit{et al.}\cite{Dumont2016} where they proposed a distribution of parameters obtained with a Bayesian estimation method. Their fit describes well the dynamics of the OTU two most abundant OTU in each functional group, but is not the case for measured substrates. 
...
\begin{table}[ht]
	...
	\begin{tabular}{|l|l|l|l|}
		\hline
		Case 1 & $\mu_i\,[1/day]$ & $K_i\,[mg/L]$ & $\frac{1}{y_i} \, [gr/gr]$ \\ \hline
...
\begin{tabular}{|l|l|l|l|}
	\hline
	Case 2  & $\mu_i\,[1/day]$ & $K_i\,[mg/L]$ & $\frac{1}{y_i} \, [gr/gr]$ \\ \hline
...
\end{tabular}
	...
	\caption{Kinetic parameters of model \eqref{system}. Case 1 is taken from Dumont \textit{et al} \cite{Dumont2016}. Case 2 is a modification of the original parameters for model exploration.}
...
\begin{figure}[ht]
	\centering
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\textwidth]{ED_parameters_Dumont}
		\caption{Case 1 ecological diagram.}
	\end{subfigure}
~
	\begin{subfigure}[b]{0.45\textwidth}
	\includegraphics[width=\textwidth]{ED_parameters_modified}
	\caption{Case 2 ecological diagram.}
	\end{subfigure}
...
\begin{figure}[h]
	...
	\includegraphics[width=\linewidth]{Images/proof_of_concept/no_noise_200121_AOB_plot}
	\caption{}
	\label{fig:nonoise200121aobplot}
	\end{subfigure}
	\begin{subfigure}{0.45 \linewidth}
	\centering
	\includegraphics[width=\linewidth]{Images/proof_of_concept/no_noise_200121_NOB_plot}
	\caption{}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\linewidth]{Images/proof_of_concept/no_noise_200121_metabolites}
	\caption{}
