...
\begin{figure}[h]
	\centering
	\begin{subfigure}{0.45 \linewidth}
		\includegraphics[width= \textwidth]{Application/201703_day_183_315_gurobi_A_regroup_OTU_Biomass_iter_12}
		\caption{Dotted line: total biomass for model \eqref{system} \iffalse quels paramètres ?\fi. Continuous line: total biomass as predicted  by the tracking procedure.}
		\label{Total Biomass application}
	\end{subfigure}
	~
	\begin{subfigure}{0.45 \linewidth}
		\includegraphics[width=\textwidth]{Application/201703_day_183_315_gurobi_A_regroup_OTU_metabolites_iter_12}
		\caption{Metabolites. Dotted line:  data. Continuous line: the tracking procedure results.}
...
\begin{figure}[h]
	\centering
	\begin{subfigure}{0.45 \linewidth}
		\includegraphics[width=\textwidth]{Application/201703_day_183_315_gurobi_A_regroup_OTU_AOB_iter_12_plot_1}
		\caption{Dotted line: simulated AOB biomass. Continuous line: the tracking procedure results.}
		\label{AOB application}
	\end{subfigure}
	~
	\begin{subfigure}{0.45 \linewidth}
		\includegraphics[width=\textwidth]{Application/201703_day_183_315_gurobi_A_regroup_OTU_NOB_iter_12_plot_1}
...
\begin{figure}[h]
	\centering
	\begin{subfigure}{0.45 \linewidth}
		\includegraphics[width=\linewidth]{Application/201703_day_183_315_gurobi_A_regroup_OTU_Control_AOB_iter_12_plot_1}
		\caption{Control for the AOB population.}
		\label{Control application}
	\end{subfigure}
	\begin{subfigure}{0.45 \linewidth}
		\centering
		\includegraphics[width=\linewidth]{Application/201703_day_183_315_gurobi_A_regroup_OTU_Control_NOB_iter_12_plot_1}
		\caption{Control for the NOB population.}
		\label{Control application}
	\end{subfigure}
	\caption{}
	\begin{subfigure}{0.45 \linewidth}
		\includegraphics[width=\linewidth]{Application/201703_day_183_315_gurobi_A_regroup_OTU_growth_AOB_iter_12_plot_1}
		\caption{Growth rate of the model for AOB community.}
		\label{AOB_growth_application}
	\end{subfigure}
	\begin{subfigure}{0.45 \linewidth}
		\centering
		\includegraphics[width=\linewidth]{Application/201703_day_183_315_gurobi_A_regroup_OTU_growth_NOB_iter_12_plot_1}
		\caption{Growth rate of the model for the NOV community.}
		\label{NOB_growth_application}
	\end{subfigure}
	\caption{}
	\begin{subfigure}{0.45 \linewidth}
		\includegraphics[width=\linewidth]{Application/201703_day_183_315_gurobi_A_regroup_OTU_growth_control_AOB_iter_12_plot_1}
		\caption{Growth rate of the model for AOB community.}
		\label{AOB_growth_control_application}
	\end{subfigure}
	\begin{subfigure}{0.45 \linewidth}
		\centering
		\includegraphics[width=\linewidth]{Application/201703_day_183_315_gurobi_A_regroup_OTU_growth_control_NOB_iter_12_plot_1}
		\caption{Growth rate of the model for the NOV community.}
